...
const routes = [
  ...
  { path: '/merchandising/:productId', name: 'MerchandisingProductPage', component: MerchandisingProductPage },
  { path: '/tickets', name: 'TicketsPage', component: TicketsPage },
  { path: '/news', name: 'NewsPage', component: NewsPage },
  { path: '/news/:newId', name: 'SingleNewPage', component: SingleNewPage },
  { path: '/event/:eventId', name: 'EventPage', component: EventPage },
  { path: '/artist/:artistId', name: 'ArtistPage', component: ArtistPage },
  { path: '/venue/:venueId', name: 'VenuePage', component: VenuePage },
  ...
  { path: '/favorites', name: 'AccountFavoritesArtistsPage', component: AccountFavoritesArtistsPage },
];
